...
def run():
   ...
   # print(device1Geo,device2Geo)
    ...
    while traci.simulation.getMinExpectedNumber()>0: #when we have exahused all of our route files 
        ...
        ped1=Person(1) #create the person to access person class
        ...
        if(len(detectedPerson)==1):
            ...
            y2Prime=device_two_coord[1]-(distTwoPrime*math.sin(angleRad2)) #for going down
                ...
                if(warnCounter==5):
                    ...
                    if(median<slopeMedian[0]):
                       ...
                       # ped1.setNewX(ped1.getAngle(),ped1.getSpeed())
                        ...
                        print("current x:",averagePrimeX)
                        print("current y",averagePrimeY)
                        print("new x:", new_X)
                        print("new y:", new_Y)
